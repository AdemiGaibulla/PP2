...
bg = pygame.transform.scale(pygame.image.load("PP2/TSIS7/images/mainclock.png"), (500, 500))

left_arm = pygame.image.load("PP2/TSIS7/images/leftarm.png")
right_arm = pygame.image.load("PP2/TSIS7/images/rightarm.png")
