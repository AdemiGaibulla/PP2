        ...
        if current_tool == 'brush':  
            ...
            if event.type == pygame.MOUSEMOTION:
                if drawStarted:
                    pos = event.pos
                    a = abs(((pos[0] - startPos[0])**2 + (pos[1] - startPos[1])**2)**0.5)
                    points.append(((startPos[0]),(startPos[1])))
                    points.append(((startPos[0]), (startPos[1] - a)))
                    points.append(((startPos[0] + a), (startPos[1] - a))) 
                    points.append(((startPos[0] + a), startPos[1])) 
                    pygame.draw.polygon(screen, active_color, points)
            ...
            if event.type == pygame.MOUSEMOTION:
                if drawStarted:
                    ...
                    a = abs(((pos[0] - startPos[0])**2 + (pos[1] - startPos[1])**2)**0.5)
                    points.append(((startPos[0]),startPos[1])) 
                    points.append(((pos[0] - (pos[0] - startPos[0])), (pos[1] - a))) 
                    points.append(((pos[0] + (pos[0] - startPos[0])), (pos[1] - a))) 
                    pygame.draw.polygon(screen, active_color, points)
